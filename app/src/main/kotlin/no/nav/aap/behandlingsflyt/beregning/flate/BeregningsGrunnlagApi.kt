                        ...
                        is GrunnlagYrkesskade -> {
                            BeregningDTO(
                                ...
                                grunnlag11_19 = Grunnlag11_19DTO(
                                    ...
                                    inntekter = (beregning.underliggende() as Grunnlag11_19).inntekter().map { it.år.value to it.beløp.verdi() }
                                ),
                        ...
                        is GrunnlagUføre -> {
                            BeregningDTO(
                                ...
                                grunnlagUføre = GrunnlagUføreDTO(
                                    ...
                                    uføreInntekterFraForegåendeÅr = beregning.underliggendeYtterligereNedsatt().inntekter().map { it.år.value to it.beløp.verdi() },
...
fun grunnlag11_19_to_DTO(grunnlag:Grunnlag11_19):Grunnlag11_19DTO{
    return Grunnlag11_19DTO(
        ...
        inntekter = grunnlag.inntekter().map { it.år.value to it.beløp.verdi() }
    )
}