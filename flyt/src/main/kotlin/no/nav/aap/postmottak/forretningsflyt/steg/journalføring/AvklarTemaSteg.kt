...
class AvklarTemaSteg(
    ...
    override fun utfør(kontekst: FlytKontekst): StegResultat {
        ...
        return if (temavurdering == null) {
            val utledetTema = utledTema(kontekst.behandlingId, journalpost)
            if (utledetTema != null) {
                avklarTemaRepository.lagreTemaAvklaring(kontekst.behandlingId, utledetTema.skalTilAap, utledetTema.tema)
            } else {
    ...
    private fun utledTema(behandlingId: BehandlingId, journalpost: Journalpost): TemaVurdering? {
        return when {
